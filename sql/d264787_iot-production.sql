...
(3,	'e45148442a7aea958f018d2f454bd54f',	'AA:dht11home',	'Testovacie zariadenie.',	NULL,	NULL,	NULL,	1,	'j62gwger1fnjm5cik6l92a27zmw9vas3pqxzq2nw',	'0f2a5r21tzztam07pp4l3aj4qkj9ey8do5gl8kem',	1,	NULL,	NULL,	NULL,	NULL,	NULL);
...
CREATE TABLE `main_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '[A]Index',
  `name` varchar(30) COLLATE utf8_bin NOT NULL COMMENT 'Zobrazený názov položky',
  `link` varchar(30) COLLATE utf8_bin NOT NULL COMMENT 'Odkaz',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Hlavné menu';
...
CREATE TABLE `sensors` (
  ...
  `name` varchar(100) COLLATE utf8_czech_ci NOT NULL,
  `id_device_classes` int(11) NOT NULL COMMENT 'Typ snímania',
  `id_value_types` int(11) NOT NULL COMMENT 'Jednotky',
  ...
  `warning_icon` tinyint(4) DEFAULT 0 COMMENT 'Upozornenie na chýbajúca dáta',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_main` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_rauser_state` (`id_user_state`),
...
CREATE TABLE `user_roles` (
  ...
  `name` varchar(80) COLLATE utf8_bin NOT NULL DEFAULT 'Registracia cez web' COMMENT 'Názov úrovne registrácie',
  `color` varchar(15) COLLATE utf8_bin NOT NULL DEFAULT 'fff' COMMENT 'Farba pozadia',
  PRIMARY KEY (`id`)
