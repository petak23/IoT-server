...
CREATE TABLE `blobs` (
  ...
  `extension` varchar(50) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `filename` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  `session_id` mediumint DEFAULT NULL,
  `remote_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `device_classes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `desc` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_czech_ci;
...
CREATE TABLE `devices` (
  ...
  `passphrase` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  `first_login` datetime DEFAULT NULL,
  `last_login` datetime DEFAULT NULL,
  `last_bad_login` datetime DEFAULT NULL,
  `user_id` smallint NOT NULL,
  `json_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  `blob_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  `monitoring` tinyint DEFAULT NULL,
  `app_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  `uptime` int DEFAULT NULL,
  `rssi` smallint DEFAULT NULL,
  `config_ver` smallint DEFAULT NULL,
  `config_data` text CHARACTER SET utf8 COLLATE utf8_czech_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lang` (
  ...
  `acronym` varchar(3) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'sk' COMMENT 'Skratka jazyka',
  `name` varchar(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'Slovenčina' COMMENT 'Miestny názov jazyka',
  `name_en` varchar(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'Slovak' COMMENT 'Anglický názov jazyka',
...
CREATE TABLE `notifications` (
  ...
  `custom_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `prelogin` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hash` varchar(20) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `device_id` smallint NOT NULL,
  `started` datetime NOT NULL,
  `remote_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `session_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `rausers` (
  ...
  `phash` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `role` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'user',
  `id_user_roles` int NOT NULL DEFAULT '1' COMMENT 'Rola užívateľa',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `prefix` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `id_rauser_state` int NOT NULL DEFAULT '10',
  ...
  `self_enroll_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `self_enroll_error_count` tinyint DEFAULT '0',
  `cur_login_time` datetime DEFAULT NULL,
  `cur_login_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `cur_login_browser` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `prev_login_time` datetime DEFAULT NULL,
  `prev_login_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `prev_login_browser` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `last_error_time` datetime DEFAULT NULL,
  `last_error_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `last_error_browser` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `monitoring_token` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sensors` (
  ...
  `desc` varchar(256) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `data_session` varchar(20) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `warn_max_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `warn_min_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `updates` (
  ...
  `fromVersion` varchar(200) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'verze, ze které se aktualizuje',
  `fileHash` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'hash souboru',
...
CREATE TABLE `user_roles` (
  ...
  `name` varchar(80) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'Registracia cez web' COMMENT 'Názov úrovne registrácie',
  `color` varchar(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'fff' COMMENT 'Farba pozadia',
  PRIMARY KEY (`id`)
...
CREATE TABLE `value_types` (
  `id` int NOT NULL AUTO_INCREMENT,
  `unit` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `view_detail` (
  ...
  `sensor_ids` varchar(30) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'List of SENSORS, comma delimited',
  ...
  `color_1` varchar(20) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL DEFAULT '255,0,0' COMMENT 'Color (R,G,B) for primary data',
  `color_2` varchar(20) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL DEFAULT '0,0,255' COMMENT 'Color (R,G,B) for comparison year',
  PRIMARY KEY (`id`)
...
CREATE TABLE `view_source` (
  `id` tinyint NOT NULL,
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `short_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL
...
CREATE TABLE `views` (
  `id` smallint NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'Chart name - title in view window, name in left menu.',
  `vdesc` varchar(1024) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'Description',
  `token` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL COMMENT 'Security token. All charts (views) with the same token will be displayed in together (with left menu for switching between)',
  `vorder` smallint NOT NULL COMMENT 'Order - highest on top.',
  `render` varchar(10) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL DEFAULT 'view' COMMENT 'Which renderer to use ("view" is only available now)',
  `allow_compare` tinyint NOT NULL DEFAULT '1' COMMENT 'Allow to select another year for compare?',
  `user_id` smallint NOT NULL,
  `app_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL DEFAULT 'RatatoskrIoT' COMMENT 'Application name in top menu',
  PRIMARY KEY (`id`)
